...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0f] py-24">
      {/* Gradient orbs */}
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <div className="relative">
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-2 border-white/10 ring-4 ring-violet-500/20">
              <img
                src={dp}
                className="w-full h-full object-cover"
              />
            </div>
            <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-emerald-400 border-2 border-[#0a0a0f]" />
          </div>
        </motion.div>
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8">
            ...
            <span className="text-sm text-gray-400 tracking-wide">Available for opportunities</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <Button
            variant="outline"
            size="lg"
            className="border-white/20 text-white hover:bg-white/10 rounded-full px-8 h-12 text-base font-medium transition-all duration-300 bg-transparent"
        ...
        >
          {[
            ...
            <a
              ...
              href={social.href}
              target="_blank"
              className="p-3 rounded-full border border-white/10 text-gray-400 hover:text-white hover:border-white/30 hover:bg-white/5 transition-all duration-300"
